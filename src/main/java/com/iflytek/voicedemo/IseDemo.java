...
public class IseDemo extends Activity implements OnClickListener {
    ...
    private EvaluatorListener mEvaluatorListener = new EvaluatorListener() {
        ...
        public void onResult(EvaluatorResult result, boolean isLast) {
            ...
            if (isLast) {
                ...
                try {
                    ...
                    Result iseResult = resultParser.parse(mLastResult);
                    if (iseResult != null) {
                        score = String.valueOf(iseResult.total_score);
                    }
                } catch (Exception e) {
                    Log.e(TAG, "解析总分失败", e);
                }
                ...
                mDbHelper.insertLog(currentTime, score, "无");
            }
        }
        ...
        public void onError(SpeechError error) {
            ...
            if (error != null) {
                ...
                // 保存错误日志
                String currentTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault()).format(new Date());
                mDbHelper.insertLog(currentTime, "0", error.getErrorCode() + ":" + error.getErrorDescription());
            } else {
    ...
    private void initUI() {
        ...
        findViewById(R.id.btn_show_log).setOnClickListener(IseDemo.this);
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.image_ise_set) {
            ...
            mIseStartButton.setEnabled(true);
            showTip("取消测评");
        } else if (id == R.id.btn_show_log) {
            Intent intent = new Intent(IseDemo.this, LogActivity.class);
